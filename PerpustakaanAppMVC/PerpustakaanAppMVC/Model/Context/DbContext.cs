    ...
    public class DbContext : IDisposable
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"D:\AMIKOM\Semester 3\Pemrograman Lanjut\11\tugaspert11btncari-main\Tugas_OperasiCRUDMVCPart2-main\PerpustakaanAppMVC\Database\DbPerpustakaan.db";
